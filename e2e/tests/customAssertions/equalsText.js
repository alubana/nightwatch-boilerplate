 ...
 *      browser.assert.equalsText('#main', 'The Night Watch');
 *    };
 * ```
 * @originalAuthor beatfactor - Leveraged the existing function containsText
 * @method containsText
...
exports.assertion = function(selector, expectedText, msg) {
  ...
  let MSG_ELEMENT_NOT_FOUND = 'Testing if element <%s> equals text: "%s". ' +
